...
namespace Beeper.Console.MidiFiles
{
    public class Class1
    {
        ...
        public void Try23()
        {
            ...
            //var _listener = new LowLevelKeyboardListener();
            System.Console.WriteLine("Press any Key to skip..");
            //_listener.OnKeyPressed += (e, s) => cancellationTokenSource.Cancel();
            InterceptKeys.KeyPressed += (_, _) => cancellationTokenSource.Cancel();
