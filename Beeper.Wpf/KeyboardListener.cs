...
// Copied from https://gist.github.com/Ciantic/471698
        ...
        private IntPtr LowLevelKeyboardProc(int nCode, UIntPtr wParam, IntPtr lParam)
        {
            ...
            if (nCode >= 0)
                if (wParam.ToUInt32() == (int)InterceptKeys.KeyEvent.WM_KEYDOWN 
                    ...
                    InterceptKeys.KeyEvent keyEvent = (InterceptKeys.KeyEvent)wParam.ToUInt32();
                    int vkCode = Marshal.ReadInt32(lParam);
                    string chars1 = chars;
                    //hookedKeyboardCallbackAsync.BeginInvoke(keyEvent, vkCode,chars1, null, null);
                    KeyDown?.Invoke(this, new RawKeyEventArgs(vkCode, isSysKey: false, chars)
                    {
